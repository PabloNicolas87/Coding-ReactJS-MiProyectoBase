...
# Primero, eliminar todo builder antiguo
sed -i '/name: 🔨 Build & Push BUILDER image/,/docker\/login-action@v2/d' "$WORKFLOW"

# Ahora, tras la línea uses: docker/login-action@v2, 
# insertamos con la indentación precisa los bloques de with: y build/runtime:
